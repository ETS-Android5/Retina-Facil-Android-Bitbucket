...
import com.unichristus.lit.retinafacil2.Models.Paciente;
...
import com.unichristus.lit.retinafacil2.Utils.GlideApp;
...
public class PatientActivity extends AppCompatActivity {
    ...
    Object cameraActivity;

    private static final String TAG = "PatientAcitivity";
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    ...
                    if(result.getResultCode() == 60){
                        Log.d(TAG, "Entered on 60");
                        Intent intent = result.getData();
                        if(intent!=null) {
                            Log.d("Result", "Aceitou intent");
                            String data = intent.getStringExtra("pathPhoto");
                            if(data !=null ) {
                                GlideApp.with(getApplicationContext()).load(data).into(photoViewer);
                                flipNext();
    ...
    public void openNewPatientDialog(View v){
        ...
        final EditText patientET = dialog.findViewById(R.id.patientET);
    ...
    public void getPhotoByCamera() throws CameraAccessException {
        Intent i = new Intent(PatientActivity.this, CameraIntent.class);
        fotoFile = null;
        try {
    ...
    private File createImageFile() throws IOException {
        ...
        File mImageFolder = getExternalFilesDir(Environment.DIRECTORY_PICTURES);
        File image = File.createTempFile(
                imageFileName,  /* prefix */
                ".jpg",         /* suffix */
                mImageFolder      /* directory */
        );
...
//                    Bitmap image = (Bitmap) imageReturnedIntent.getExtras().get("data");
    ...
    public void openDeletePhotoDialog(View v){
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle("Deletar fotos");
